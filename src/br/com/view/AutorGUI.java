...
public class AutorGUI extends javax.swing.JFrame {
    ...
    public AutorGUI(DefaultTableModel modelo) {
        this.modelo = modelo;
        initComponents();
    }

    
    public AutorGUI(DefaultTableModel modelo, int linhaSelecionada, int IdAutor){
        this.modelo = modelo;
        this.linhaSeIecionada = linhaSelecionada;
        initComponents();
        
        AutorController ac = new AutorController();
        Autor a = ac.pesquisarCodigo(IdAutor);
