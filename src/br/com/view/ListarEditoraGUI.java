 ...
 * @author emily_borges
 */
public class ListarEditoraGUI extends javax.swing.JFrame {
    private JTable tabela = new JTable();
    private DefaultTableModel modelo = new DefaultTableModel();
    
    
    public ListarEditoraGUI() {
        initComponents();
        criaTabela();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(503, 435));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setPreferredSize(new java.awt.Dimension(503, 435));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(scrol, javax.swing.GroupLayout.PREFERRED_SIZE, 481, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(btBuscaNome, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoActionPerformed
        EditoraGUI gui = new EditoraGUI(modelo);
        gui.setVisible(true);
    ...
    private void btDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeletarActionPerformed
      int linhaSelecionada = tabela.getSelectedRow();
        if(linhaSelecionada >= 0) {
            int idEditora = (int) tabela.getValueAt(linhaSelecionada, 0);
            EditoraController ec = new EditoraController();
            if (ec.remover(idEditora) == true) {
            modelo.removeRow(linhaSelecionada);
        }
            
        }else{
           JOptionPane.showMessageDialog(null,"É necessario selecionar uma editora.");
        }
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
       int linhaSelecionada = tabela.getSelectedRow();
        if(linhaSelecionada >= 0) {
            int idEditora = (int) tabela.getValueAt(linhaSelecionada, 0);
           EditoraGUI gui = new EditoraGUI (modelo, linhaSelecionada, idEditora);
            gui.setVisible(true);
    ...
    private void txBuscaNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txBuscaNomeActionPerformed
       ...
       modelo.setNumRows(0);
       for (Editora e: ec.PesquisarEditoraNome(Nome)) {
           modelo.addRow(new Object[] {e.getCodigo(),e.getNome() });
